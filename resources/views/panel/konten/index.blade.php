...
<div class="row mb-3 align-items-center">
  ...
  <div class="col-6 text-end">
    <a data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample" class="btn btn-link text-dark"><i class="bi bi-filter me-1"></i>Filter</a>
    <a href="{{ url('panel/konten/create') }}" class="btn btn-primary"><i class="bi bi-plus-circle me-1"></i>Tambah</a>
  </div>
</div>
      ...
      <form action="{{ route('konten.search') }}" method="GET">
        <div class="row align-items-end">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="judul" id="judul" class="form-control" placeholder="Kata kunci...">
          </div>
